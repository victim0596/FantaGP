...
function checkDriverQualy() {
    if (pronoQualy.qp1 == pronoQualy.qp2 || pronoQualy.qp1 == pronoQualy.qp3 || pronoQualy.qp2 == pronoQualy.qp3) {
        if (urlPage == "http://localhost/Git/FantaGP/pronostici.php") textError.innerHTML = "Hai inserito uno stesso pilota in uno degli altri campi";
        ...
        if (driverArray.indexOf(pronoQualy.qp1) >= 0 && driverArray.indexOf(pronoQualy.qp2) >= 0 && driverArray.indexOf(pronoQualy.qp3) >= 0) {
            ...
            if (urlPage == "http://localhost/Git/FantaGP/pronostici.php") textError.innerHTML = "";
            else textErrorProfile.innerHTML = "";
        }
        else {
            if (urlPage == "http://localhost/Git/FantaGP/pronostici.php") textError.innerHTML = "Hai inserito un pilota non esistente/Campo vuoto";
