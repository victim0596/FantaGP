...
<body>
  ...
  include 'mod_quali.php';
  include 'mod_race.php'; ?>
...
<!-- Alert -->
  ...
  <div class="alert alert-primary d-flex align-items-center classAlert" id="alert" role="alert">
    ...
    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:"><use xlink:href="#check-circle-fill" id="simbolID"/></svg>  
    <?php echo $text; ?></div>
