...
$arrayGara = array();
$index = 0;
$sql = "SELECT id_p,nome_gara,qp1,qp2,qp3,gp1,gp2,gp3,giro_veloce,n_ritirati,VSC,SC,punti FROM pronostici WHERE punti>=0 and punti IS NOT NULL ORDER BY id_p,nome_gara";
